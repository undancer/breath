...
public class OSSFileSystem extends AbstractFileSystem {
    ...
    protected OSSFileSystem(OSSClient client, OSSFileName rootName, FileSystemOptions fileSystemOptions) {
        this(client, rootName, null, fileSystemOptions);
    }

    protected OSSFileSystem(OSSClient client, OSSFileName rootName, FileObject parentLayer, FileSystemOptions fileSystemOptions) {
